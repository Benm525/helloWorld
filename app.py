...
# created training route, access for ADMIN and Manager only. Displays message for trainee.
@app.route('/training')
@login_required
@role_required(['ADMIN', 'MANAGER'])
def training():
    flash(
        ...
        '<a href="mailto: bmcdona1@terpmail.edu</a> if you wish to be placed on the waiting list.'
    )
